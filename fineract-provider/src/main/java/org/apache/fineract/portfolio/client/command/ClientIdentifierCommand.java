...
public class ClientIdentifierCommand {
    ...
    public ClientIdentifierCommand(final Long documentTypeId, final Long proofTypeId, final String documentKey, final LocalDate validity, final boolean isLifeTime, final String locale, final String dateFormat, final String statusString, final String description) {
