...
public class PaymentDetailConstants {
    ...
    public static final String chequeDateParamName = "chequeDate";
    ...
    public static final Set<String> PAYMENT_CREATE_REQUEST_DATA_PARAMETERS = new HashSet<>(Arrays.asList(accountNumberParamName,
            checkNumberParamName, routingCodeParamName, receiptNumberParamName, bankNumberParamName, chequeDateParamName, bankNameParamName));
