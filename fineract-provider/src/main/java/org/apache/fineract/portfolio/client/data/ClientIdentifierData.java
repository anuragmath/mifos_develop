...
public class ClientIdentifierData {
    ...
    public static ClientIdentifierData singleItem(final Long id, final Long clientId, final CodeValueData documentType,
            final CodeValueData proofType, final String documentKey, final LocalDate validity,final Boolean isLifeTime, final String locale, final String dateFormat, final String status, final String description) {
    ...
    public ClientIdentifierData(final Long id, final Long clientId, final CodeValueData documentType, final CodeValueData proofType, final String documentKey, 
    		final LocalDate validity, final Boolean isLifeTime, final String locale, final String dateFormat,
            final String description, final String status, final Collection<CodeValueData> allowedDocumentTypes, final Collection<CodeValueData> allowedProofTypes) {
        this.id = id;
